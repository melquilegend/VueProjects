    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="billerZipCode">Codigo Postal</label>
      ...
      <div class="bill-to flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="clientStreetAddress">Endereço (Cliente)</label>
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="clientZipCode">Codigo Postal</label>
      ...
      <div class="invoice-work flex flex-column">
        <div class="payment flex">
          ...
          <div class="input flex flex-column">
            <label for="paymentDueDate">Data do Pagamento</label>
        ...
        <div class="input flex flex-column">
          ...
          <select required type="text" id="paymentTerms" v-model="paymentTerms">
            <option value="30">Unica Prestação 30 Dias</option>
            <option value="60">2 Prestações  60 Dias </option>
          </select>
        </div>
        <div class="input flex flex-column">
          <label for="productDescription">Descrição de Produto / Serviço</label>
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple">Salvar Rascunho</button>
          <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Criar Fatura</button>
          <button v-if="editInvoice" type="sumbit" class="purple">Atualizar Fatura</button>
        </div>
      </div>
    </form>
  </div>
